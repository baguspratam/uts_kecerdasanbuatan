...
kb.add_fact(("bagus", "adalah_orangtua_dari", "tari"))
kb.add_fact(("bagus", "adalah_orangtua_dari", "nurul"))
kb.add_fact(("bagus", "adalah_orangtua_dari", "yanto"))
kb.add_fact(("alim", "adalah_orangtua_dari", "tari"))
kb.add_fact(("alim", "adalah_orangtua_dari", "nurul"))
kb.add_fact(("alim", "adalah_orangtua_dari", "yanto"))
kb.add_fact(("pratama", "adalah_orangtua_dari", "wanda"))
...
kb.add_fact(("Pratama", "adalah_saudaralaki2_dari", "yanto"))
kb.add_fact(("yanto", "adalah_saudaralaki2_dari", "pratama"))
kb.add_fact(("aji", "adalah_saudaralaki2_dari", "gunawan"))
kb.add_fact(("gunawan", "adalah_saudaralaki2_dari", "aji"))
kb.add_fact(("desi", "adalah_saudaraperempuan_dari", "rina"))
kb.add_fact(("rina", "adalah_saudaraperempuan_dari", "desi"))
...
kb.add_fact(("pratama", "adalah_paman_dari", "aji"))
kb.add_fact(("pratama", "adalah_paman_dari", "gunawan")) 
kb.add_fact(("pratama", "adalah_paman_dari", "anggun")) 
kb.add_fact(("pratama", "adalah_paman_dari", "boy")) 
...
kb.add_fact(("bagus", "adalah_kakek_dari", "wanda"))
kb.add_fact(("bagus", "adalah_kakek_dari", "aji"))
kb.add_fact(("bagus", "adalah_kakek_dari", "gunawan"))
